...
assertTrueValue(str_contains($transparentCustomCSS, '--ipsview-control-background: rgba(255, 255, 255, 0.720);'), 'CSS must render translucent control backgrounds.');
assertTrueValue(str_contains($transparentCustomCSS, '--ipsview-label-background: rgba(255, 255, 255, 0.000);'), 'CSS must render fully transparent label backgrounds.');
